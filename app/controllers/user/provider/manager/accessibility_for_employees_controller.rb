...
class User::Provider::Manager::AccessibilityForEmployeesController < User::Provider::Manager::ManagerController
  ...
  def update
    result = ::Provider::Manager::Accessibility::Employees::Update.result(
  ...
  def destroy
    result = ::Provider::Manager::Accessibility::Employees::Destroy.result(
