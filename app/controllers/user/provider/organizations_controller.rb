...
class User::Provider::OrganizationsController < User::Provider::ProviderController
  ...
  def create
    result = ::Provider::Organizations::Create.result(
      owner: current_user,
  ...
  def update
    result = ::Provider::Organizations::Update.result(
      owner: current_user,
      attributes: organization_params
    )
